...
class Docentes extends Conexion{
    ...
    public function add($Nombre, $Apellido, $Usuario, $Contrasena){
        $statement = $this->db->prepare("INSERT INTO usuario (Nombre, Apellido, Usuario, Contraseña, Perfil, Estado) VALUES (:Nombre, :Apellido, :Usuario, :Contrasena, 'Docente', 'Activo')");
    ...
    public function getById($Id){
        $rows = null;
        $statement = $this->db->prepare("SELECT * FROM usuario WHERE Perfil = 'Docente' AND Id_Usuario = :Id");
